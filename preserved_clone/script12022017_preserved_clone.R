...
ref <-  2 # Select the ancient data as test   # changed 20012016
test <- 1 #  Select the recent data as reference
...
cexLabels = 1.4
#sizeGrWindow(6,9)
pdf(file = "1202_2017_recent_Specific-NetworkAndIGPStatistics.pdf", w=6, h=9, onefile = FALSE)
par(mfrow = c(3,2))
...
for (f in 1:2)  {
  pdf(file=spaste("1202_2017_recentancient-recentSpecific-modulePreservation-", figNames[f],"-%02d.pdf"),
...
pdf("1202_2017_MotivationFigure-dendrosAndTable.pdf")
fp = TRUE
