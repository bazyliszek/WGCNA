...
path="./DE_preserved_clone" # This is a folder name 
...
ff <- list.files(path="./DE_preserved_clone", full.names=TRUE)
myfilelist <- lapply(ff, read.table, col.names = "Gene") # header = F
names(myfilelist) <- list.files(path="./DE_preserved_clone", full.names=FALSE)
...
names(DE_genes_kog) <- list.files(path="./DE_preserved_clone", full.names=FALSE)
str(DE_genes_kog)
...
names(DE_KOG_JGI_count) <- list.files(path="./DE_preserved_clone", full.names=FALSE) # 266
...
names(DE_KOG_cat_list) <- list.files(path="./DE_preserved_clone", full.names=FALSE)
...
names(DE_KOG_tes_list) <- list.files(path="./DE_preserved_clone", full.names=FALSE)
...
names(final_tes_list) <- list.files(path="./DE_preserved_clone", full.names=FALSE)
...
names(end_tes_list) <- list.files(path="./DE_preserved_clone", full.names=FALSE)
...
names(new_matched_tes) <- list.files(path="./DE_preserved_clone", full.names=FALSE)
...
testes_list[[i]]
names(testes_list) <- list.files(path="./DE_preserved_clone", full.names=FALSE)
...
names(final_testes_list) <- list.files(path="./DE_preserved_clone", full.names=FALSE)
...
names(end_testes_list) <- list.files(path="./DE_preserved_clone", full.names=FALSE)
...
names(withcutoff) <- list.files(path="./DE_preserved_clone", full.names=FALSE)
